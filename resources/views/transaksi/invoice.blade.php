...
<body onload="javascript:window.print()">
    <div class="invoice">
        <img src="/adminlte/dist/img/lndry.jpeg" alt="" class="logo">
        ...
        <p>
            ...
            Tanggal Bayar : {{ date('d/m/Y', strtotime($transaksi->tgl_bayar)) }} <br>
            Tanggal Diambil : {{ date('d/m/Y', strtotime($transaksi->batas_waktu)) }} <br>
